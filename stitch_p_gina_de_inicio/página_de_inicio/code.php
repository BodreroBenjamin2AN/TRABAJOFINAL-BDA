...
<div class="flex items-center gap-4">
<button class="flex h-10 w-10 items-center justify-center rounded-full bg-background-light dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
...
<p class="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">© 2024 SportZone. Todos los derechos reservados.</p>
</div>
</footer>
</div>
</div>
